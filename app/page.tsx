    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-900 to-indigo-900 text-white flex items-center justify-center p-6">
      <div className="max-w-2xl text-center">
        ...
        <p className text-slate-300 mb-8">
          Paste your book title. Get KDP-ready keywords,
          a formatted description & title ideas — in 5 seconds.
        </p>
        ...
        <Link
          href="/generate"
          className-amber-400 text-slate-900 font-bold text-lg px-10 py-4 rounded-full hover:bg-amber-300 transition"
        >
